...
SELECT specialty_description, COUNT (total_claim_count) AS sum_claim
FROM prescription
LEFT JOIN prescriber
USING (npi)
...
CASE
	...
	ELSE 'neither'
END AS drug_type,
SUM(total_drug_cost) AS sum_cost
FROM drug
